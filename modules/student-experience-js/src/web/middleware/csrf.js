...
/**
 * A synchronizer-token CSRF guard, matching Spring Security's default (enabled, per-session
 * token) since the Java module never calls `.csrf(disable)`. Every state-changing form
